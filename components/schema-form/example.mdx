...
const [schema] = useState({
  ...
  properties: {
    brand: { 
      ...
      type: 'string',
      format: 'brandPO',
      props: { renderConditions: {margin: 10, minMargin: 5} }
    },
    agreementType: {
  ...
  hideAsterisk: ['agreementType'],
  required: ['agreementType', 'articleType'],
});
